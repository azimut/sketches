...
module holder (angle,width,thickness,lip_bottom,lip_top) {
  difference() {
    translate([-width/4,0,0])
      ...
      polyRoundExtrude(holder_silloute(lip_bottom = 1, thickness = thickness, angle = angle),
                       width/2,
                       0.5,
                       0.5);
    rotate([90-angle,0,0])
...
function holder_silloute (thickness = 10, lip_top = 4, lip_bottom = 2, radius = 3, angle = 45) =
